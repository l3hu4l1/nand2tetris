...
Each command is translated separately. In particular, each mnemonic component is translated into its corresponding bit code and each symbol is resolved to its numeric address.
